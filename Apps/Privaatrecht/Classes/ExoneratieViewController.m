  ...
  if (navigationType == UIWebViewNavigationTypeLinkClicked) {
    ...
    if (compResult == NSOrderedSame) {
      UIAlertView *alertTest = [[UIAlertView alloc]
                                initWithTitle:@"Privaatrecht 2010"
...
-(void) alertView: (UIAlertView *) alertView clickedButtonAtIndex: (NSInteger) buttonIndex
{
  if (buttonIndex == 1) {
    ...
    if (openmail == YES) {
      [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"mailto:info@active8.nl?subject=Privaatrecht_2010"]] ;
    }
  }
  opensafari = NO ;
  openmail   = NO ;
...
-(void) viewDidLoad
{
  [self.webView loadHTMLString:@"<html><head><style> body {font-family: sans-serif; font-size: 12px;} table {font-family: sans-serif; font-size: 12px;} a {color: #ff6600;}</style></head><body>Een product van Active8 B.V.<br/><table border='0' cellspacing='0' cellpadding='1'><tr colspan='2'><td></td></tr><tr><td>Versie:</td><td>Oktober 2010</td></tr><tr><td>Telefoon:</td><td>010-4144399</td></tr><tr><td>Email:</td><td><a href='mailto:info@active8.nl'>info@active8.nl</a></td></tr><tr><td>Website:</td><td><a href='http://www.active8.nl'>www.active8.nl</a></td></tr></body></html>" baseURL:nil] ;
