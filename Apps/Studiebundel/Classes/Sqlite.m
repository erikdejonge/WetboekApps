...
-(NSArray *) executeQueryCopy: (NSString *) sql, ...
  {
  va_list args;
  ...
  NSArray *result = [self executeQueryCopy:sql arguments:argsArray];

  [argsArray release];
  return(result);
}

-(NSArray *) executeQueryCopy: (NSString *) sql arguments: (NSArray *) args
{
